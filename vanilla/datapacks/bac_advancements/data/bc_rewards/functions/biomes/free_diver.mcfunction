...
execute if score reward bac_settings matches 1 run tellraw @s {"color":"green","text":" +1 ","extra":[{"translate":"enchantment.minecraft.aqua_affinity"},{"text":" "},{"translate":"item.minecraft.enchanted_book"}]}
