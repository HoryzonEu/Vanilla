...
### Crafted item ###
execute if score @s dnl.craftpoint matches 9 run summon item ~ ~ ~ {Item:{id:"minecraft:yellow_shulker_box",Count:1b,tag:{display:{Name:'{"text":"Hive Chest","color":"gold","italic":false}'}}}}
