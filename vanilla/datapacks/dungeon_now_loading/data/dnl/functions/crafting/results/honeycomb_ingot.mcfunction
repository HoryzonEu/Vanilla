...
### Crafted item ###
execute if score @s dnl.craftpoint matches 9 run summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",Count:1b,tag:{display:{Name:'{"text":"Honeycomb Ingot","color":"gold","italic":false}'},dnl.honeycomb_ingot:1b,CustomModelData:13001}}}
