...
# test queen's_nest #
execute at @s[tag=!dnl.used] if block ~-1 ~ ~ minecraft:chiseled_stone_bricks if block ~-1 ~1 ~ minecraft:bee_nest{Bees:[{EntityData:{id:"minecraft:bee"}},{EntityData:{id:"minecraft:bee"}},{EntityData:{id:"minecraft:bee"}}]} run tag @s add dnl.used
